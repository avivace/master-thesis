...
CERN, the European Organization for Nuclear Research is a European research organization that operates the world’s largest and most powerful particle accelerator, the Large Hadron Collider.
...
The LHC collides two beams (\textit{bunches}) of protons at a combined energy of 13 TeV, accelerating them around a 27-kilometre ring of superconducting magnets until they reach 99,9999990\% of the speed of light.

Colliding the beams in the LHC is the responsibility of CERN. Exploiting these collisions is the responsibility of large international scientific collaborations, known as \textit{experiments}. Each experiment has a detector, a large experimental apparatus placed at a collision point.
...
\begin{enumerate}
	...
	\item The unobservable dark matter giving galaxies the extra gravity to stay intact; \cite{bertone2005particle};
...
Cross section ($\sigma$) is one of the most important quantity in particle physics: it measures the probability that a specific process occurs in a collision of two particles. It is expressed in terms of the transverse area that the particle must hit to for that process to occur and it's measured in \textit{Barn}: $1b = 10^{-24} cm^2$.
...
Figure \ref{fig:cross_sections} shows $\sigma$ values for different particles. Notice how the value increments with the collision energy $\sqrt s$ (13 TeV during Run 2).
