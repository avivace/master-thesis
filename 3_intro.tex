...
At CERN, 2500 staff members design, construction and operates the research infrastructure, in addition to more than 17500 users and scientists of 110 nationalities, from institutes in more than 70 countries.

Colliding the beams in the LHC is the responsibility of CERN. Exploiting these collisions
is the responsibility of large international scientific collaborations: the \textit{experiments}. Each experiment has a detector, a large experimental apparatus placed at a collision point of the LHC.

The main collision points (shown in \ref{fig:cern_complex}) equipped with experiments are:
