...
This work encompasses research, maintenance and development on one of the sources of monitored data: the underlying software providing Trigger Rates data to Trigger Shifters (CMS operators monitoring the detector status) and to the new monitoring framework.
