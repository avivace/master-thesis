...
- www as open source (1994), mention the licence
- open-source hardware (with the CERN Open Hardware Licence)
- open access (with the Sponsoring Consortium for Open Access Publishing in Particle Physics
- open data (with the Open Data Portal for the LHC experiments).
- MAlt
