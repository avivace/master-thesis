...
Since we require just a couple of variables, this fits perfectly our use case, providing also a preliminary validation on the integrity of the file. The emitted configuration Python object is then passed to the database connection class.
